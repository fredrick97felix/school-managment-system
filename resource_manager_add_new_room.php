...
if ($_SESSION['reg_no']=="") {
  ...
  $sql="INSERT INTO `room` (	no,	building_name  ,school_reg_no, capacity)VALUE('$room_no','$building','$school_reg_no','$capacity')";
  if(mysqli_query($con,$sql)){
       $msg_success="you have successfully inserted new room";
        ...
        require_once'includes/PHPExcel/Classes/PHPExcel/IOFactory.php';
          ...
          foreach($objPHPExcel->getWorksheetIterator() as $worksheet){
            ...
            for($row=2;$row<=$highestRow;$row++){
              $building= $worksheet->getCellByColumnAndRow(0,$row)->getValue();
              $room_no= $worksheet->getCellByColumnAndRow(1,$row)->getValue();
              $capacity= $worksheet->getCellByColumnAndRow(2,$row)->getValue();
              
              $school_reg_no= $_SESSION['school_reg_no'];
              $sql_building="SELECT `name` 
              FROM   `building`
             WHERE  school_Reg_no='$school_reg_no' && name='$building'";  
             $sql_run=mysqli_query($con,$sql_building);
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="resource_manager_add_new_room.php" method="post" enctype="multipart/form-data">
   ...
   function checkform(){
          ...
          <form action="resource_manager_add_new_room.php" method="POST" enctype="multipart/form-data" id="room_form">
<div class="row"> 
<div class="col-4 mb-3">building</div>
<div class="col-8 mb-3">        
<select name="building" id="" form="room_form" class="form-control">
  <?php
  $sql_building="SELECT `name` 
  FROM   `building`
  WHERE  school_Reg_no='$school_reg_no' "; 

if( $rett=mysqli_query($con,$sql_building)){
...
<div class="row">
                    <div class="col-4 mb-3">room number</div>
                    <div class="col-8 mb-3">
                      <input type="text" class="form-control" id="status" name="room_no"  value="<?php echo $specification?>" required="true"></div>
                    </div>


                    <div class="row">
                    <div class="col-4 mb-3">capacity</div>
                    <div class="col-8 mb-3">
                      <input type="text" class="form-control" id="status" name="capacity"  value="<?php echo $status?>" required="true"></div>
