  ...
  //header('location:logout.php');
   ...
   session_destroy();
    ...
    if(isset($_POST['add'])){
         ...
         $qury="SELECT `school_reg_no` ,`rank`,reg_no 
                FROM   `staff`
                WHERE  school_Reg_no='$School_reg_no' && rank==' $rank' && reg_no=$Reg_no";
        ...
        require'includes/PHPExcel/Classes/PHPExcel.php';
         ...
         foreach($objPHPExcel->getWorksheetIterator() as $worksheet){
          ...
          for($row=2;$row<=$highestRow;$row++){
            ...
            $rank= $worksheet->getCellByColumnAndRow(0,$row)->getValue();
            $School_reg_no=$_SESSION['school_reg_no'];
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="head_register_staff.php" method="post" enctype="multipart/form-data">
...
<form name="addNewResource" action="head_register_staff.php " class="user" method="post" onsubmit="return checkform();" id="form_staff"  >
                    ...
                    <div class="col-8 mb-3">
                    <select name="rank" id="" form="form_staff" class="form-control">
