...
if ($_SESSION['reg_no']=="") {
  ...
  if(isset($_POST['add'])){
    ...
    $sql="INSERT INTO `building` (	 	name  ,school_reg_no)VALUE('$name','$school_reg_no')";
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- content here -->
                    ...
                    <h1 class="h3 mb-4 text-gray-800">Add new building</h1>
                    <div class="col-7"></div>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="resource_manager_add_new_building.php" method="post" enctype="multipart/form-data">
